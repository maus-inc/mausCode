...
- [x] 6. Remove codex-acp dep (+asarUnpack); KEPT acp-ai-provider (still used by gemini/hermes routers; cursor migrated off ACP to native print 2026-09-11) and normalizer (shared with cursor) + coalescer (still used)
