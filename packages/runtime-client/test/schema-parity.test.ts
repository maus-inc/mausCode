...
import { API_VERSION_MAJOR, KNOWN_EVENT_KINDS, KNOWN_REQUEST_KINDS } from "../dist/index.js"

const here = path.dirname(fileURLToPath(import.meta.url))
// mausCode: Rust sources live in the vendored runtime (see UPSTREAM.md), not in a
// monorepo parent. Override with JCODE_HARNESS_API_SRC when the vendor location
