...
> live ledger `.dump/ci/research/fork-network-harvest-catalog.md` (which по matter of fact this brief
...
- NEVER: take deletions from any fork (their removals = the "AI-bro feature removal" user explicitly
  wants釘 away; we keep our kanban/claude-login/sub-chats-sidebar.; and以 merge migrations verbatim
