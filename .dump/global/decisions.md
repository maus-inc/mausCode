...
| Release channels are defined now, with a notary placeholder and no signing until a human provisions certificates | 2026-09-14 | same, answering `questions.md` item 7 | Step 32 grows from an unsigned build into alpha and stable channel definitions plus a placeholder for notarization; `questions.md` item 8, the Apple developer account, stays open because it needs money and an admin seat, not code |
