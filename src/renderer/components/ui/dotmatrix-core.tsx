// Vendored from github.com/zzzzshawn/matrix (dotmatrix dotm-square-12 registry item).
// License: Custom Proprietary License (app use permitted, incl. commercial; do NOT
// republish as a standalone component/library). Vendored 2026-09-11; biome-formatted.
// biome-ignore-all lint/style/noNonNullAssertion: vendored upstream code, assertions are upstream's.
"use client"
