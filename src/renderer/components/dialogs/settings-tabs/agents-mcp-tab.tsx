      ...
      <div className="max-w-2xl mx-auto p-6 space-y-6">
        ...
        {provider === "cursor" && (
          <p className="text-xs text-muted-foreground">
            Managed in <code className="bg-muted px-1 py-0.5 rounded">.cursor/mcp.json</code> (project) or <code className="bg-muted px-1 py-0.5 rounded">~/.cursor/mcp.json</code> (global)
          </p>
        )}
