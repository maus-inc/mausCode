  ...
  return (
    <>
      <ContextMenu>
        ...
        >
          {/* biome-ignore lint/a11y/useKeyWithClickEvents: tree container handles Enter/Space/arrows via bubbling; a row handler would double-fire. */}
          <div
            ref={rowRef}
            role="treeitem"
            tabIndex={-1} // keyboard focus stays on the tree container (roving); rows reachable programmatically only
