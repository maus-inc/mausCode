...
function TextSelectIcon({ className }: { className?: string }) {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" className={className}>
      <path
        d="M5 4C4.44772 4 4 4.44772 4 5C4 5.55228 4.44772 6 5 6H19C19.5523 6 20 5.55228 20 5C20 4.44772 19.5523 4 19 4H5Z"
        fill="currentColor"
      />
      <path
        d="M5 9C4.44772 9 4 9.44772 4 10C4 10.5523 4.44772 11 5 11H15C15.5523 11 16 10.5523 16 10C16 9.44772 15.5523 9 15 9H5Z"
        fill="currentColor"
      />
      <path
        d="M5 14C4.44772 14 4 14.4477 4 15C4 15.5523 4.44772 16 5 16H11C11.5523 16 12 15.5523 12 15C12 14.4477 11.5523 14 11 14H5Z"
        fill="currentColor"
      />
      <path
        d="M5 19C4.44772 19 4 19.4477 4 20C4 20.5523 4.44772 21 5 21H17C17.5523 21 18 20.5523 18 20C18 19.4477 17.5523 19 17 19H5Z"
        fill="currentColor"
      />
    </svg>
  )
...
export function AgentDiffTextContextItem({
  ...
  return (
    <div className="relative flex items-center gap-2 pl-1 pr-2 py-1 rounded-lg bg-muted/50 group cursor-default min-w-[120px] max-w-[200px]">
      {/* Icon container */}
