...
export function AgentFileItem({ filename, size, isLoading = false, onRemove }: AgentFileItemProps) {
  const Icon = getFileIcon(filename)

  return (
    <div className="relative flex items-center gap-2 pl-1 pr-2 py-1 rounded-lg bg-muted/50 group min-w-[120px] max-w-[200px]">
