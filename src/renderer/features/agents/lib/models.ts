...
export const GROK_MODEL_IDS = new Set(GROK_MODELS.map((model) => model.id))
...
export const QWEN_MODEL_IDS = new Set(QWEN_MODELS.map((model) => model.id))
...
export const CLINE_MODEL_IDS = new Set(CLINE_MODELS.map((model) => model.id))
...
export const OPENCLAW_MODEL_IDS = new Set(OPENCLAW_MODELS.map((model) => model.id))
...
export const ROO_MODEL_IDS = new Set(ROO_MODELS.map((model) => model.id))
