...
/**
 * mausCode Dark - Default dark theme (inherited base design)
 * Uses blue (#0034FF) as primary/accent color
 */
const MAUSCODE_DARK: VSCodeFullTheme = {
  id: "mauscode-dark",
  name: "mausCode Dark",
  type: "dark",
  source: "builtin",
...
/**
 * mausCode Light - Default light theme (inherited base design)
 * Uses blue (#0034FF) as primary/accent color
 */
const MAUSCODE_LIGHT: VSCodeFullTheme = {
  id: "mauscode-light",
  name: "mausCode Light",
  type: "light",
  source: "builtin",
 ...
 */
export const DEFAULT_LIGHT_THEME_ID = "mauscode-light"
export const DEFAULT_DARK_THEME_ID = "mauscode-dark"
