...
// biome-ignore lint/suspicious/noExplicitAny: web backend AppRouter type unavailable in this repo (see TODO)
type AppRouter = any
 ...
 */
// The web backend AppRouter type isn't available in the desktop repo.
// All remote API calls go through remote-api.ts which handles the typing.
// biome-ignore lint/suspicious/noExplicitAny: web backend AppRouter type unavailable in this repo
