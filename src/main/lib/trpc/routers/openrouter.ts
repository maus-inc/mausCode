...
import { type ModelMessage, streamText, type UIMessage, type UIMessageChunk } from "ai"
...
function convertStoredMessagesToModelMessages(storedMessages: StoredChatMessage[]): ModelMessage[] {
  ...
  for (const msg of storedMessages) {
    ...
    if (msg.role === "user") {
      ...
      const imageParts: ModelFilePart[] = []
