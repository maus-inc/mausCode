...
export type QwenCredential = typeof qwenCredentials.$inferSelect
export type NewQwenCredential = typeof qwenCredentials.$inferInsert
export type ClineCredential = typeof clineCredentials.$inferSelect
export type NewClineCredential = typeof clineCredentials.$inferInsert
export type OpenclawCredential = typeof openclawCredentials.$inferSelect
export type NewOpenclawCredential = typeof openclawCredentials.$inferInsert
export type RooCredential = typeof rooCredentials.$inferSelect
export type NewRooCredential = typeof rooCredentials.$inferInsert
