...
// Strip ANSI SGR colour codes before parsing. The pattern is assembled from
// a string escape instead of a regex literal containing a raw control
// character, so the matcher stays exactly `\x1b\[[0-9;]*m`.
